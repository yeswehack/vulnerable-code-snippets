...
echo -e "[\033[36mINF\033[0m] Is this correct? ( [CTRL+C] to cancel) Waiting 3 secounds... before continue";
sleep 3;
...
[\033[36mINF\033[0m] To make MySQL changes you need to enter the sudo password (\033[3;33mnot the user your about to create\033[0m)";
